    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="教学内容" prop="jiaoxueneirong">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="教学内容"
                  v-model="ruleForm.jiaoxueneirong" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.jiaoxueneirong" label="教学内容" prop="jiaoxueneirong">
                    <span>{{ruleForm.jiaoxueneirong}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="教学目标" prop="jiaoxuemubiao">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="教学目标"
                  v-model="ruleForm.jiaoxuemubiao" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.jiaoxuemubiao" label="教学目标" prop="jiaoxuemubiao">
                    <span>{{ruleForm.jiaoxuemubiao}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="教学重点" prop="jiaoxuezhongdian">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="教学重点"
                  v-model="ruleForm.jiaoxuezhongdian" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.jiaoxuezhongdian" label="教学重点" prop="jiaoxuezhongdian">
                    <span>{{ruleForm.jiaoxuezhongdian}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="课程安排" prop="kechenganpai">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.kechenganpai" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.kechenganpai" label="课程安排" prop="kechenganpai">
                    <span v-html="ruleForm.kechenganpai"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.jiaoxuemubiao = true;
          ...
          if(o=='jiaoxuezhongdian'){
            this.ruleForm.jiaoxuezhongdian = obj[o];
	    this.ro.jiaoxuezhongdian = true;
            continue;
          }
          if(o=='kechenganpai'){
            this.ruleForm.kechenganpai = obj[o];
	    this.ro.kechenganpai = true;
            continue;
          }
          if(o=='jiaoshigonghao'){
    ...
    kechengmingchengChange () {
      this.$http({
        url: `follow/zaixiankecheng/kechengmingcheng?columnValue=`+ this.ruleForm.kechengmingcheng,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
              if(data.data.kemuleixing){
                this.ruleForm.kemuleixing = data.data.kemuleixing
              }
        } else {
          this.$message.error(data.msg);
        }
	...
	this.ruleForm.kechenganpai = this.ruleForm.kechenganpai.replace(reg,'../../../springboot0b6e5/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
