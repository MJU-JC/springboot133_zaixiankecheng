<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="课件名称" prop="kejianmingcheng">
          <el-input v-model="ruleForm.kejianmingcheng" 
              placeholder="课件名称" clearable  :readonly="ro.kejianmingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="课件名称" prop="kejianmingcheng">
              <el-input v-model="ruleForm.kejianmingcheng" 
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="课件文件" prop="kejianwenjian">
          <file-upload
          tip="点击上传课件文件"
          action="file/upload"
          :limit="1"
          :multiple="true"
          :fileUrls="ruleForm.kejianwenjian?ruleForm.kejianwenjian:''"
          @change="kejianwenjianUploadChange"
          ></file-upload>
        </el-form-item>  
        <div v-else>
          <el-form-item v-if="ruleForm.kejianwenjian" label="课件文件" prop="kejianwenjian">
            <el-button type="text" size="small" @click="download(ruleForm.kejianwenjian)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="课件内容" prop="kejianneirong">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.kejianneirong" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.kejianneirong" label="课件内容" prop="kejianneirong">
                    <span v-html="ruleForm.kejianneirong"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.kemuleixing = true;
          ...
          if(o=='kejianmingcheng'){
            this.ruleForm.kejianmingcheng = obj[o];
	    this.ro.kejianmingcheng = true;
            continue;
          }
          if(o=='kejianneirong'){
            this.ruleForm.kejianneirong = obj[o];
	    this.ro.kejianneirong = true;
            continue;
          }
          if(o=='kejianwenjian'){
            this.ruleForm.kejianwenjian = obj[o];
	    this.ro.kejianwenjian = true;
            continue;
          }
          if(o=='shangchuanriqi'){
	...
	this.ruleForm.kejianneirong = this.ruleForm.kejianneirong.replace(reg,'../../../springboot0b6e5/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `kejianxinxi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.kejianxinxiCrossAddOrUpdateFlag = false;
                  this.parent.search();
    ...
    kejianwenjianUploadChange(fileUrls) {
	this.ruleForm.kejianwenjian = fileUrls;
			this.addEditUploadStyleChange()
    },
